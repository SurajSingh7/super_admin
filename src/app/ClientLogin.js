...
const ClientLogin = () => {
    ...
    return (
        ...
        <div className="flex flex-col items-center bg-white p-6 rounded shadow-md w-full max-w-md">
            <Toaster />
            <h1 className="text-2xl text-orange-500 text-center font-bold">GIGANTIC</h1>
            <p className="text-center text-gray-600 mt-2">The world&#39;s largest code broadband platform.</p>
            ...
            <form onSubmit={handleLogin} className="w-full mt-6">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className={`w-full py-2 text-white rounded ${loading ? 'bg-gray-400' : 'bg-orange-500 hover:bg-orange-600'}`}
                >
